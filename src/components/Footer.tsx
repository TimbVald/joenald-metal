...
export default function Footer() {
  return (
    <footer id="footer" className="relative bg-zinc-50 dark:bg-zinc-950 text-zinc-650 dark:text-zinc-400 pt-24 pb-12 border-t border-zinc-200 dark:border-zinc-900 overflow-hidden transition-colors duration-300">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20 relative z-10 text-left">
        {/* Colonne 1 : Logo & Slogan */}
        <div className="flex flex-col space-y-6">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative overflow-hidden rounded-md border border-yellow-500/30 p-0.5 bg-white dark:bg-zinc-900">
              <Image 
                src="/images/logo.jpg" 
        ...
        <div>
          <h3 className="text-sm font-bold text-zinc-900 dark:text-white uppercase tracking-wider mb-6 after:content-[''] after:block after:w-8 after:h-0.5 after:bg-yellow-500 after:mt-2">
            Services
          </h3>
          <ul className="space-y-3">
            {[
              ...
              <li key={link.name}>
                <Link 
                  href={link.href} 
                  className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-500 transition-colors duration-300 flex items-center gap-1.5 group"
                >
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+27634923367" className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-500 transition-colors font-medium">
                +27 63 492 3367
              </a>
            </li>
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:famenijoel@gmail.com" className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-500 transition-colors break-all font-medium">
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-6">
            <a href="#" className="w-10 h-10 rounded-md bg-zinc-200 dark:bg-zinc-900 border border-zinc-350 dark:border-zinc-850 hover:border-yellow-500 dark:hover:border-yellow-500 text-zinc-600 dark:text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-500 flex items-center justify-center transition-all duration-300 font-bold" aria-label="Facebook">
              Fb
            </a>
            <a href="#" className="w-10 h-10 rounded-md bg-zinc-200 dark:bg-zinc-900 border border-zinc-350 dark:border-zinc-850 hover:border-yellow-500 dark:hover:border-yellow-500 text-zinc-600 dark:text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-500 flex items-center justify-center transition-all duration-300 font-bold" aria-label="LinkedIn">
              Ln
            </a>
          </div>
          <p className="text-xs text-zinc-550 dark:text-zinc-500 leading-relaxed font-medium">
            Notre atelier est ouvert du lundi au vendredi de 9h à 18h et le samedi de 10h à 14h.
          </p>
        </div>
      </div>

      <div className="container mx-auto px-6 pt-8 border-t border-zinc-200 dark:border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4 relative z-10">
        <p className="text-xs text-zinc-550 dark:text-zinc-500 text-center md:text-left font-medium">
          &copy; {new Date().getFullYear()} Joenald Metal Engineering. Tous droits réservés.
        </p>
        <div className="flex gap-6 text-xs text-zinc-550 dark:text-zinc-500 font-medium">
