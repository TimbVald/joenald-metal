...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-zinc-200 dark:border-zinc-800/80 py-4 transition-colors duration-300">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full flex justify-between items-center text-left focus:outline-none"
        aria-expanded={isOpen}
      >
        <span className="font-bold text-zinc-900 dark:text-white text-sm md:text-base hover:text-yellow-600 dark:hover:text-yellow-500 transition-colors duration-200">
          {question}
        </span>
        <span className="text-yellow-600 dark:text-yellow-500 text-xl font-bold ml-4">
          {isOpen ? '−' : '+'}
        </span>
      </button>
      <div
...
function ContactFormContent() {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-850 p-8 rounded-lg shadow-md dark:shadow-xl relative overflow-hidden transition-colors duration-300">
      ...
      {submitStatus === 'success' ? (
        <div className="text-center py-12 animate-fade-in">
          <div className="w-16 h-16 bg-yellow-500/10 text-yellow-600 dark:text-yellow-500 rounded-full flex items-center justify-center mx-auto mb-6 border border-yellow-500/20">
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" /></svg>
          </div>
          <h3 className="text-2xl font-bold text-zinc-900 dark:text-white mb-2">Message Envoyé !</h3>
          <p className="text-zinc-650 dark:text-zinc-400 text-sm max-w-sm mx-auto leading-relaxed">
            Merci pour votre demande. Nos ingénieurs l&apos;étudient avec attention et vous recontacteront sous 24h à 48h.
          </p>
          <button
            onClick={() => setSubmitStatus('idle')}
            className="mt-8 bg-zinc-800 text-white dark:bg-zinc-950 dark:text-zinc-200 font-bold text-xs uppercase tracking-wider px-6 py-2.5 rounded-sm hover:bg-zinc-700 dark:hover:bg-zinc-900 transition-colors"
          >
            Nouveau message
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <h3 className="text-xl font-bold text-zinc-900 dark:text-white tracking-tight">Envoyer un Message</h3>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label htmlFor="name" className="block text-zinc-550 dark:text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2">
                Nom complet
              </label>
              <input
                type="text"
                ...
                className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 focus:border-yellow-600 dark:focus:border-yellow-500 rounded-sm py-3 px-4 text-sm text-zinc-850 dark:text-white focus:outline-none transition-all placeholder:text-zinc-400 dark:placeholder:text-zinc-600 shadow-sm"
                placeholder="Ex. Jean Du Toit"
              />
            </div>
            <div>
              <label htmlFor="email" className="block text-zinc-550 dark:text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2">
                Adresse Email
              </label>
              <input
                type="email"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label htmlFor="phone" className="block text-zinc-550 dark:text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2">
                Téléphone
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="service" className="block text-zinc-550 dark:text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2">
                Service Demandé
              </label>
              <select
                id="service"
                ...
                className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 focus:border-yellow-600 dark:focus:border-yellow-500 rounded-sm py-3 px-4 text-sm text-zinc-800 dark:text-zinc-300 focus:outline-none transition-all cursor-pointer shadow-sm"
              >
          ...
          <div>
            <label htmlFor="message" className="block text-zinc-550 dark:text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2">
      ...
      <main className="container mx-auto px-6 py-20 max-w-6xl flex-grow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="order-last lg:order-first">
            <Suspense fallback={
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-850 p-8 rounded-lg animate-pulse h-96 flex items-center justify-center">
          ...
          <div className="space-y-10">
            <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-850 p-8 rounded-lg shadow-md relative overflow-hidden transition-colors duration-300">
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-yellow-500/30"></div>
              
              <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-6">Coordonnées de l&apos;Atelier</h3>
              
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="p-3 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-yellow-600 dark:text-yellow-500 rounded-sm shrink-0 shadow-sm">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  </div>
                  <div>
                    <h4 className="font-bold text-zinc-900 dark:text-white text-sm">Adresse</h4>
                    <p className="text-zinc-650 dark:text-zinc-400 text-sm mt-1 leading-relaxed font-medium">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-zinc-900 dark:text-white text-sm">Téléphone</h4>
                    <p className="text-zinc-650 dark:text-zinc-400 text-sm mt-1 font-medium">
                      <a href="tel:+27634923367" className="hover:text-yellow-650 dark:hover:text-yellow-500 transition-colors">
                        +27 63 492 3367
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-650 dark:text-zinc-400 text-sm mt-1 break-all font-medium">
                      <a href="mailto:famenijoel@gmail.com" className="hover:text-yellow-650 dark:hover:text-yellow-500 transition-colors">
                ...
                <div className="flex gap-4 border-t border-zinc-200 dark:border-zinc-800 pt-6 mt-6">
                  <div className="p-3 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-yellow-600 dark:text-yellow-500 rounded-sm shrink-0 shadow-sm">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  </div>
                  <div>
                    <h4 className="font-bold text-zinc-900 dark:text-white text-sm">Horaires d&apos;Ouverture</h4>
                    <p className="text-zinc-600 dark:text-zinc-400 text-xs mt-1 leading-relaxed font-semibold">
            ...
            <div className="w-full overflow-hidden rounded-lg border border-zinc-200 dark:border-zinc-850 shadow-md dark:shadow-xl relative h-72">
              <iframe
                ...
                className="absolute inset-0 opacity-90 dark:opacity-80 hover:opacity-100 transition-opacity"
              ></iframe>
            </div>
          </div>
        </div>
        ...
        <section className="mt-32 max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-yellow-600 dark:text-yellow-500 font-extrabold text-xs uppercase tracking-widest">Des réponses à vos questions</span>
            <h2 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight mt-2">
              Foire Aux Questions
            </h2>
            <div className="w-16 h-1 bg-yellow-500 mx-auto mt-4 rounded-full"></div>
          </div>

          <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-850 rounded-lg p-8 space-y-4 shadow-sm transition-colors duration-300">
            <FAQItem
