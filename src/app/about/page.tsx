...
export default function About() {
  return (
    <div className="flex min-h-screen flex-col bg-zinc-950 text-zinc-100 font-sans">
      ...
      <section className="py-24 bg-zinc-950">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-yellow-500 font-extrabold text-xs uppercase tracking-widest">Notre Mission</span>
              ...
              <p className="text-zinc-450 leading-relaxed mb-8 text-sm">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-md">
                  <h4 className="font-extrabold text-yellow-500 text-lg">Qualité de Pointe</h4>
                  <p className="text-xs text-zinc-400 mt-1">Matériaux certifiés de haute résistance.</p>
                </div>
                <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-md">
                  <h4 className="font-extrabold text-yellow-500 text-lg">Sur Mesure</h4>
                  <p className="text-xs text-zinc-400 mt-1">Conception adaptée à chaque contrainte.</p>
                </div>
              </div>
            </div>
            <div className="relative h-[450px] w-full rounded-lg overflow-hidden border border-zinc-850 shadow-2xl">
              <Image
      ...
      {/* Section Frise Chronologique / Timeline */}
      <section className="py-24 bg-zinc-900 border-y border-zinc-800/80">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            <span className="text-yellow-500 font-extrabold text-xs uppercase tracking-widest">Une décennie d&apos;évolution</span>
            <h2 className="text-3xl font-extrabold text-white mt-2">Notre Chronologie</h2>
            <div className="w-16 h-1 bg-yellow-500 mx-auto mt-4 rounded-full"></div>
          </div>

          <div className="relative border-l border-zinc-850 ml-4 md:ml-32">
            {[
              ...
              <div key={idx} className="mb-12 relative pl-8 group">
                ...
                <div className="absolute -left-1.5 top-1.5 w-3.5 h-3.5 rounded-full bg-zinc-900 border-2 border-yellow-500 group-hover:bg-yellow-500 transition-colors duration-300"></div>
                <div className="absolute left-[-130px] top-1 hidden md:block w-24 text-right">
                  <span className="text-lg font-black text-yellow-500">{milestone.year}</span>
                </div>
                <div className="bg-zinc-950 border border-zinc-850 p-6 rounded-lg group-hover:border-yellow-500/20 transition-colors">
                  <span className="text-xs text-yellow-500 font-bold md:hidden block mb-1">{milestone.year}</span>
      ...
      <section className="py-24 bg-zinc-950">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-20">
            <span className="text-yellow-500 font-extrabold text-xs uppercase tracking-widest">Nos Fondations</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-zinc-900 border border-zinc-850/80 p-8 rounded-lg text-center hover:border-yellow-500/20 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-yellow-500/10 text-yellow-500 flex items-center justify-center mx-auto mb-6 border border-yellow-500/20">
